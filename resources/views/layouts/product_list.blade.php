                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group col">
                          ...
                          <!-- <label class="radio-inline"><input type="radio" name="optradio" value="{{ $item_type->type_id }}">{{ $item_type->type_desc }}</label> -->
                          @endforeach
                        </div>
                      </div>
                      ...
                      <!-- <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input id="product_type" type="text" class="form-control{{ $errors->has('product_type') ? ' is-invalid' : '' }}" name="product_type" required>
